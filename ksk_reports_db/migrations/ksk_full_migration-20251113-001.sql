...
-- ============================================================================
-- Дата создания: 2025-11-13 09:58:20
...
-- Добавление колонки created_date (идемпотентно)
		SELECT upoa_ksk_reports.add_column_if_not_exists('ksk_result', 'created_date', 'TIMESTAMP(3)','NOW()'::TEXT);
...
-- Дата завершения: 2025-11-13 09:58:21
-- ============================================================================
