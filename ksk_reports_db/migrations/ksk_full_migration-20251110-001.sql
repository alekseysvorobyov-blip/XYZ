...
-- ============================================================================
-- Дата создания: 2025-11-10 14:48:54
...
BEGIN
    ...
    LOOP
        ...
        VALUES (
            ...
            COALESCE(((v_figurant_record.figurant_data)::jsonb)->'searchCheckResultsExclusionList'->'nameList', '')
        )
...
-- Дата завершения: 2025-11-10 14:48:54
-- ============================================================================
